...
int main(){
	...
	printf("There are %d ones in the multiple", count);

	//nth prime
	int nprime = nthPrime(12);
	printf("%d is nth prime", nprime);

	//nth fibonacci
	int nfib = nthFibonacci(12);
	printf("%d is nth fibonacci", nfib);

	//decimal to octal
	int num = decimalToOctal(12);
	printf("%d is the octal value of 12", num);

	//decimal to octal fraction
	float numfrac = decimalToOctalFraction(12.22);
	printf("%f is the octal value of 12.22", numfrac);
